...
<head>
    ...
    <title>Infraestrutura da Etec da Zona Leste</title>
...
<body>
    ...
    <main>
        <section class="Adm" id="pri2-sessão">
            <h3 style="text-align:center;">INFRAESTRUTURA DA ETEC DA ZONA LESTE</h3>&nbsp;&nbsp;
            <!--Segundo texto com Foto-->
            <div class="flex flex-col justify-center">
                <img src="/img/Infra1.jpg" class="card-img-top" alt="Ilustração referente a HISTÓRIA DA ETEC" max-width="100%" height="auto" />
                <div class="banner-secondary_wysiwyg">
                    <p>&nbsp;&nbsp;</p>
                    <p style="text-align:center;">Em 6 de abril de 2002, foi inaugurada a ETEC da Zona Leste de São Paulo, um centro de ensino que oferece uma gama diversificada de cursos técnicos e superiores.
                        Localizada na Avenida Águia de Haia, 2683, Cidade A.E. Carvalho, São Paulo, a escola possui uma infraestrutura completa.</p>
                    <p style="text-align:center;">Suas instalações abrangem desde salas de aula modernas até laboratórios bem equipados, uma biblioteca bem fornecida, enfermaria, teatro, áreas de lazer e duas quadras poliesportivas, uma delas coberta.
                        Além disso, o amplo estacionamento e o sistema de segurança interno, com câmeras de vigilância, oferecem comodidade e tranquilidade aos estudantes e visitantes.</p>
                    <p style="text-align:center;">Uma característica notável da ETEC da Zona Leste é a oferta de cursos técnicos modulares e descentralizados, que proporcionam uma abordagem flexível e adaptável ao aprendizado.
                        Adicionalmente, a escola disponibiliza diversos cursos gratuitos, ampliando o acesso à educação de qualidade.</p>
                    <p style="text-align:center;">Com uma estrutura tão completa e uma gama diversa de cursos, a ETEC da Zona Leste se destaca como uma instituição comprometida com o desenvolvimento educacional e profissional de seus alunos.</p>
                    <p>&nbsp;</p>
                </div>
            </div>
        </section>
