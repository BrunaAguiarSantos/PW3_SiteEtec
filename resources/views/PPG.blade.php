...
<body>
    ...
    <main>
        <section class="Adm" id="pri2-sessão">
            <h3 style="text-align:center;">PPG- Plano Plurianual de Gestão</h3>&nbsp;&nbsp;
            <!--Segundo texto com Foto-->
            <div class="flex flex-col justify-center">
                <img src="/img/PPG.jpg" class="card-img-top" alt="Ilustração referente a HISTÓRIA DA ETEC" max-width="100%" height="auto" />
                <div class="banner-secondary_wysiwyg">
                    <p>&nbsp;&nbsp;</p>
                    <p style="text-align:center;">O Plano Plurianual de Gestão (PPG) das Etecs tem por objetivo indicar as principais ações que deverão ser norteadoras do fazer da Unidade de Ensino no próximo quinquênio.</p>
                    <p>&nbsp;</p>
                </div>
            </div>
        </section>
        <section>
            <div class="text-center">
                <p>&nbsp;&nbsp;</p>
                <a type="button" class="btn btn-outline-success" href="/pdf/PPG-2023-2027_211.pdf" download>Clique aqui para fazer o dowload da PPG</a>
            </div>
        </section>
        <p>&nbsp;&nbsp;</p>
        <div class="text-center">
