...
<head>
    ...
    <title>Regimento Comum das Etecs</title>
...
<body>
    ...
    <main>
        <section class="Adm" id="pri2-sessão">
            <h3 style="text-align:center;">Regimento Comum das Etecs</h3>&nbsp;&nbsp;
            <!--Segundo texto com Foto-->
            <div class="flex flex-col justify-center">
                <img src="/img/RCE1.png" class="card-img-top" alt="Ilustração referente a HISTÓRIA DA ETEC" max-width="100%" height="auto" />
                <div class="banner-secondary_wysiwyg">
                    <p>&nbsp;&nbsp;</p>
                    <p style="text-align:center;">DELIBERAÇÃO CEETEPS Nº 87, de 28 de dezembro de 2022 – Aprova nova redação do Regimento Comum das Escolas Técnicas Estaduais do Centro Estadual de Educação Tecnológica Paula Souza</p>
                    <p>&nbsp;</p>
                </div>
            </div>
        </section>
        <section>
            <div class="text-center">
                <p>&nbsp;&nbsp;</p>
                <a type="button" class="btn btn-outline-success" href="/pdf/deliberao_ceeteps_87_2022_12_28.pdf" download>Clique aqui para fazer o dowload do Regimento Comum das Etecs</a>
            </div>
        </section>
        <p>&nbsp;&nbsp;</p>
        <div class="text-center">
